...
public class SensorData
{
    ...
    /**
     * Method to find all the unique devices found from all the data in the CSV file. Used for the events panel.
     * @return The linked list of unique sensor devices found.
     */
    public LinkedList<DataLine> findUniqueDevices()
    {
